...
bvar: VREGP "%a"
block: INDIRB(bvar) "v_addpi(%c,v_lp,__DRLP__ %0);\n"
block: INDIRB(reg) "%0"
...
reg: ics   "%c = %0\n"
reg: immc  "v_setc(%c,%0);\n"		1
reg: immi  "v_set%T(%c,%0);\n"		1
reg: imms  "v_sets(%c,%0);\n"		1
reg: immu  "v_set%T(%c,%0);\n"		1
...
reg: rtcf  "v_setf(%c,%0);\n"       	1
reg: rtcd  "v_setd(%c,%0);\n"       	1
reg: rtci  "v_set%T(%c,%0);\n"       	1
reg: rtcp  "v_setp(%c,%0);\n"       	1
reg: rtcs  "v_sets(%c,%0);\n"       	1
reg: rtcu  "v_set%T(%c,%0);\n"       	1
...
stmt: ASGNI(addri,reg)	 "v_st%Ti(%1,%0);\n" 1
...
stmt: ASGNI(addr,reg)	 "v_st%T(%1,%0);\n"	1
...
reg: DIVI(reg,reg)  "v_div%T(%c,%0,%1);\n"	2
reg: DIVI(reg,imm)  "v_div%Ti(%c,%0,%1);\n"	1
reg: DIVU(reg,reg)  "v_div%T(%c,%0,%1);\n"	2
reg: DIVU(reg,imm)  "v_div%Ti(%c,%0,%1);\n"	1
reg: MODI(reg,reg)  "v_mod%T(%c,%0,%1);\n"	2
reg: MODI(reg,imm)  "v_mod%Ti(%c,%0,%1);\n"	1
reg: MODU(reg,reg)  "v_mod%T(%c,%0,%1);\n"	2
reg: MODU(reg,imm)  "v_mod%Ti(%c,%0,%1);\n"	1
reg: MULI(reg,reg)  "v_mul%T(%c,%0,%1);\n"	2
reg: MULI(imm,reg)  "v_cmul%T(%c,%1,%0);\n"	1
reg: MULU(reg,reg)  "v_mul%T(%c,%0,%1);\n"	2
reg: MULU(imm,reg)  "v_cmul%T(%c,%1,%0);\n"	1

reg: ADDI(reg,reg)  "v_add%T(%c,%0,%1);\n"	2
reg: ADDI(reg,imm)  "v_add%Ti(%c,%0,%1);\n"	1
reg: ADDP(reg,reg)  "v_addp(%c,%0,%1);\n"	2
reg: ADDP(reg,imm)  "v_addpi(%c,%0,%1);\n"	1
reg: ADDU(reg,reg)  "v_add%T(%c,%0,%1);\n"	2
reg: ADDU(reg,imm)  "v_add%Ti(%c,%0,%1);\n"	1
reg: BANDU(reg,reg) "v_and%T(%c,%0,%1);\n"	2
reg: BANDU(reg,imm) "v_and%Ti(%c,%0,%1);\n"	1
reg: BORU(reg,reg)  "v_or%T(%c,%0,%1);\n"	2
reg: BORU(reg,imm)  "v_or%Ti(%c,%0,%1);\n"	1
reg: BXORU(reg,reg) "v_xor%T(%c,%0,%1);\n"	2
reg: BXORU(reg,imm) "v_xor%Ti(%c,%0,%1);\n"	1
reg: SUBI(reg,reg)  "v_sub%T(%c,%0,%1);\n"	2
reg: SUBI(reg,imm)  "v_sub%Ti(%c,%0,%1);\n"	1
reg: SUBP(reg,reg)  "v_subp(%c,%0,%1);\n"	2
reg: SUBP(reg,imm)  "v_subpi(%c,%0,%1);\n"	1
reg: SUBU(reg,reg)  "v_sub%T(%c,%0,%1);\n"	2
reg: SUBU(reg,imm)  "v_sub%Ti(%c,%0,%1);\n"	1

reg: LSHI(reg,reg)  "v_lsh%T(%c,%0,%1);\n"	2
reg: LSHI(reg,imm)  "v_lsh%Ti(%c,%0,%1);\n"	1
reg: LSHU(reg,reg)  "v_lsh%T(%c,%0,%1);\n"	2
reg: LSHU(reg,imm)  "v_lsh%Ti(%c,%0,%1);\n"	1
reg: RSHI(reg,reg)  "v_rsh%T(%c,%0,%1);\n"	2
reg: RSHI(reg,imm)  "v_rsh%Ti(%c,%0,%1);\n"	1
reg: RSHU(reg,reg)  "v_rsh%T(%c,%0,%1);\n"	2
reg: RSHU(reg,imm)  "v_rsh%Ti(%c,%0,%1);\n"	1

reg: BCOMU(reg)     "v_com%T(%c,%0);\n"		2
reg: BCOMU(imm)     "v_com%Ti(%c,%0);\n"		1
reg: NEGI(reg)      "v_neg%T(%c,%0);\n"		2
reg: NEGI(imm)      "v_neg%Ti(%c,%0);\n"		1
...
reg: LOADI(reg)     "v_mov%T(%c,%0);\n"		1
reg: LOADI(imm)     "v_set%T(%c,%0);\n"		1
reg: LOADU(reg)     "v_mov%T(%c,%0);\n"		1
reg: LOADU(imm)     "v_set%T(%c,%0);\n"		1
...
reg: CVCI(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVCI(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVIC(reg)      "v_cv%S2%D(%c,%0);\n" 1
reg: CVIC(imm)      "v_cv%S2%Di(%c,%0);\n" 1
reg: CVSI(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVSI(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVIS(reg)      "v_cv%S2%D(%c,%0);\n" 1
reg: CVIS(imm)      "v_cv%S2%Di(%c,%0);\n" 1
reg: CVCU(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVCU(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVUC(reg)      "v_cv%S2%D(%c,%0);\n" 1
reg: CVUC(imm)      "v_cv%S2%Di(%c,%0);\n" 1
reg: CVSU(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVSU(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVUS(reg)      "v_cv%S2%D(%c,%0);\n" 1
reg: CVUS(imm)      "v_cv%S2%Di(%c,%0);\n" 1
reg: CVII(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVII(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVIU(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVIU(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVUI(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVUI(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
reg: CVUU(reg)      "v_cv%S2%T(%c,%0);\n" 1
reg: CVUU(imm)      "v_cv%S2%Ti(%c,%0);\n" 1
...
stmt: EQI(reg,reg)  "v_beq%T(%0,%1,%a);\n"	2
stmt: EQI(reg,imm)  "v_beq%Ti(%0,%1,%a);\n"	1
stmt: GEI(reg,reg)  "v_bge%T(%0,%1,%a);\n"	2
stmt: GEI(reg,imm)  "v_bge%Ti(%0,%1,%a);\n"	1
stmt: GEU(reg,reg)  "v_bge%T(%0,%1,%a);\n"	2
stmt: GEU(reg,imm)  "v_bge%Ti(%0,%1,%a);\n"	1
stmt: GTI(reg,reg)  "v_bgt%T(%0,%1,%a);\n"	2
stmt: GTI(reg,imm)  "v_bgt%Ti(%0,%1,%a);\n"	1
stmt: GTU(reg,reg)  "v_bgt%T(%0,%1,%a);\n"	2
stmt: GTU(reg,imm)  "v_bgt%Ti(%0,%1,%a);\n"	1
stmt: LEI(reg,reg)  "v_ble%T(%0,%1,%a);\n"	2
stmt: LEI(reg,imm)  "v_ble%Ti(%0,%1,%a);\n"	1
stmt: LEU(reg,reg)  "v_ble%T(%0,%1,%a);\n"	2
stmt: LEU(reg,imm)  "v_ble%Ti(%0,%1,%a);\n"	1
stmt: LTI(reg,reg)  "v_blt%T(%0,%1,%a);\n"	2
stmt: LTI(reg,imm)  "v_blt%Ti(%0,%1,%a);\n"	1
stmt: LTU(reg,reg)  "v_blt%T(%0,%1,%a);\n"	2
stmt: LTU(reg,imm)  "v_blt%Ti(%0,%1,%a);\n"	1
stmt: NEI(reg,reg)  "v_bne%T(%0,%1,%a);\n"	2
stmt: NEI(reg,imm)  "v_bne%Ti(%0,%1,%a);\n"	1
...
stmt: ARGI(reg)     "# v_arg%T(%0);\n"		1
stmt: ARGP(reg)     "# v_argp(%0);\n"		1
stmt: ARGV	    "# dynamic call;\n"		1
stmt: ARGB(block)		"# aggregate argument %0\n" 1

stmt: ASGNB(reg,block) "v_copyb(%0,%1,%Z);\n" 2

stmt: CALLB(immp,reg) "@{ v_reg_type _tc_call_result = v_ccallb(&vcs,(v_vptr)%0,%A); v_copyb(%1,_tc_call_result,%Z); v_putreg(_tc_call_result,V_P); }\n" 2
stmt: CALLB(reg,reg) "@{ v_reg_type _tc_call_result = v_rccallb(&vcs,%0,%A); v_copyb(%1,_tc_call_result,%Z); v_putreg(_tc_call_result,V_P); }\n" 2

reg:  CALLD(immp) "@{ v_reg_type _tc_call_result = v_ccalld(&vcs,(v_dptr)%0); v_movd(%c,_tc_call_result); }\n" 1
reg:  CALLF(immp) "@{ v_reg_type _tc_call_result = v_ccallf(&vcs,(v_fptr)%0); v_movf(%c,_tc_call_result); }\n" 1
reg:  CALLI(immp) "@{ v_reg_type _tc_call_result = v_ccall%T(&vcs,(v_%Tptr)%0); v_mov%T(%c,_tc_call_result); }\n" 1
stmt: CALLV(immp) "@v_ccallv(&vcs,(v_vptr)%0);\n"			1

reg:  CALLD(reg) "@{ v_reg_type _tc_call_result = v_rccalld(&vcs,%0); v_movd(%c,_tc_call_result); }\n"	1
reg:  CALLF(reg) "@{ v_reg_type _tc_call_result = v_rccallf(&vcs,%0); v_movf(%c,_tc_call_result); }\n"	1
reg:  CALLI(reg) "@{ v_reg_type _tc_call_result = v_rccall%T(&vcs,%0); v_mov%T(%c,_tc_call_result); }\n"	1
stmt: CALLV(reg) "@v_rccallv(&vcs,%0);\n"		1

stmt: RETD(reg)     "v_retd(%0);\n"		1
stmt: RETF(reg)     "v_retf(%0);\n"		1
stmt: RETI(reg)     "v_ret%T(%0);\n"		2
stmt: RETI(imm)     "v_ret%Ti(%0);\n"		1
stmt: RETB(block) "v_retb(%0,%A);\n" 1
...
static void target (Node p) {
     ...
     case INDIR:
	  if (p->op == INDIRB) {
	       setreg(p, tr);
	       eval.currentclosure->u.closure.hasaggregate = 1;
	  }
	  break;
     case CRET:
	  if (p->kids[0]->op == RTCB)
...
static void emit2 (Node p) {
     ...
     case GETREG: {
	  ...
	  print("v_getreg(&%s,%s,V_VAR);\n",
		r->x.name, tfVcodeType(n->type ? n->type : btot(optype(n->op))));
	  break;
     }
     case PUTREG: {
	  Symbol r = p->syms[0];
	  Node n = p->kids[0];
	  print("v_putreg(%s,%s);\n", r->x.name,
		tfVcodeType(n->type ? n->type : btot(optype(n->op))));
	  break;
     }
     case ICSV:
...
/*	  if (generic(k->op) == RTC || generic(k->op) == CNST) {*/
     ...
     case ASGND: case ASGNF:
	  ...
	  if (p->kids[0]->op == ADRVS) {
	       ...
	       assert(vs->type->op == VSPEC && vs->type->type
		      || vs->lclp);
	       ty = p->type ? p->type : btot(optype(p->op));
	       rs = p->kids[1]->syms[RX];
	       vn = vs->name; rn = rs->x.name;
	       print("if (_tc_stackp(%s)) {\n"
		     "  v_st%si(%s,v_lp,_tc_offset(%s));\n"
		     "} else {\n"
		     "  v_mov%s(_tc_reg(%s), %s);\n"
		     "}\n", vn, tfVcodeSuffix(ty), rn, vn,
		     tfVcodeSuffix(ty), vn, rn);
	  }
	  break;
     ...
     case INDIRD: case INDIRF:
	  ...
	  if (p->kids[0]->op == ADRVS) {
	       ...
	       vn = vs->name; rn = rs->x.name;
	       print("if (_tc_stackp(%s)) {\n"
		     "  v_ld%si(%s,v_lp,_tc_offset(%s));\n"
		     "} else {\n"
		     "  v_mov%s(%s,_tc_reg(%s));\n"
		     "}\n", vn, tfVcodeSuffix(ty), rn, vn,
		     tfVcodeSuffix(ty), rn, vn);
	  }
	  break;
     case ARGB: {
	  ...
	  print("v_arg_pushb(&vcs,%s,%s);\n", s->x.name,
		tfAggregate(p->kids[0]->type));
     }
     break;
...
static void declspec(s, v) Symbol s; void *v; {
     if (isvspec(s->type)) {
	  print("v_reg_type %s = (v_reg_type)c->%s;\n",s->name,s->name);
     } else {
     ...
     if (lp)
	  do {
	       ...
	       if (isarray(s->type) || isstruct(s->type))
		    print("v_reg_type %s = v_localb(%d);\n",
			  s->x.name, s->type->size);
	       else
		    print("v_reg_type %s = v_local(%s);\n",
...
static void emitclosureend (Code cp) {
     ...
     if (cp->u.begin->u.closure.hasaggregate)
	  print("v_putreg(%s,V_P);\n", tr->x.name);
     outs("}\n\n");
}
