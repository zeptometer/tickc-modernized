...
static char rcsid[] = "$Id: gram.y,v 1.1.1.1 1997/10/30 16:17:14 maxp Exp $";
...
rules	: /* lambda */
	...
	| rules nonterm ':' tree STRING cost '\n' {
	     if (ts == BINARY) {
		  yyerror("Bad lburg input file. Template type mismatch.\n");
		  exit(1);
	     }
